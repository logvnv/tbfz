                        ...
                        <div class="card wdt-tutorial-card m-b-18">
                            <div class="card-body wpdt-flex card-padding">
                                ...
                                <div class="wdt-tutorial-desc">
                                    <span><?php _e('Create a simple table from scratch:', 'wpdatatables'); ?><span class="f-400"><?php _e(' create a simple table with any data, merged cells, styling, star rating and a lot more.', 'wpdatatables'); ?></span></span>
